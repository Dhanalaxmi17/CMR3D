...
from proposal_module_refine import ProposalModuleRefine1, ProposalModuleRefine2, ProposalModuleRefine3
from proposal_module_surface import PrimitiveModule

from dump_helper import dump_results
from loss_helper import get_loss

class CMR3D(nn.Module):
    r"""
    ...
    def __init__(self, num_class, num_heading_bin, num_size_cluster, mean_size_arr,
       ...
       # self.backbone_net1 = Pointnet2Backbone(input_feature_dim=self.input_feature_dim) ### Just xyz + height
        ...
        self.pnet_final1 = ProposalModuleRefine1(num_class, num_heading_bin, num_size_cluster,
                                   mean_size_arr, num_proposal, sampling, seed_feat_dim=256, with_angle=with_angle)
        self.pnet_final2 = ProposalModuleRefine2(num_class, num_heading_bin, num_size_cluster,
                                   mean_size_arr, num_proposal, sampling, seed_feat_dim=256, with_angle=with_angle)
        self.pnet_final3 = ProposalModuleRefine3(num_class, num_heading_bin, num_size_cluster,
                                   mean_size_arr, num_proposal, sampling, seed_feat_dim=256, with_angle=with_angle)
    ...
    def forward(self, inputs, end_points, mode=""):
        ...
        end_points1 = self.pnet_final1(proposal_xyz, proposal_features, center_z, feature_z, center_xy, feature_xy, center_line, feature_line, end_points)
        end_points2 = self.pnet_final2(proposal_xyz, proposal_features, center_z, feature_z, center_xy, feature_xy, center_line, feature_line, end_points1)
        end_points = self.pnet_final3(proposal_xyz, proposal_features, center_z, feature_z, center_xy, feature_xy, center_line, feature_line, end_points2)
        return end_points
